...
form.addEventListener('submit', function(event) {
    ...
    if (telepon.value.trim() === '') {
            teleponError.textContent = 'Nomor telepon harus diisi';
            telepon.classList.add('error-border');
            valid = false;
    ...
    if (!setuju.checked) {
        ...
        isValid = false;
        setuju.classList.add('input-error'); 
    }
...
function clearErrors() {
    ...
    telepon.classList.remove('input-error');
    universitas.classList.remove('input-error');
    prodi.classList.remove('input-error');
    setuju.classList.remove('input-error');
};